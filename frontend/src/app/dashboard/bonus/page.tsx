    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 to-black py-8">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-red-500/10 to-orange-500/10 border-2 border-red-500/30 rounded-2xl p-8 mb-8"
        >
          <h2 className="text-2xl font-black text-white mb-4">Your Referral Link</h2>
          <p className="text-white/70 mb-6">
            Share this link with friends. When they sign up and make their first tournament payment, you'll earn ₦500!
          </p>

          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 bg-black/50 border border-white/10 rounded-xl p-4 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-6 py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition-all flex items-center gap-2"
              >
                {copied ? (
                  <>
              ...
              <button
                ...
                className="px-6 py-4 bg-green-600 hover:bg-green-700 text-white font-bold rounded-xl transition-all flex items-center gap-2"
              >
          ...
          <div className="mt-4 p-4 bg-white/5 rounded-lg">
            <div className="text-sm text-white/70 mb-2">Full Link:</div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-500 rounded-full flex items-center justify-center mx-auto mb-4 text-white text-2xl font-black">
                1
              </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-4 text-white text-2xl font-black">
                2
              </div>
              <h3 className="text-lg font-bold text-white mb-2">They Sign Up & Pay</h3>
              <p className="text-white/70 text-sm">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-yellow-500 rounded-full flex items-center justify-center mx-auto mb-4 text-white text-2xl font-black">
                3
              </div>
              <h3 className="text-lg font-bold text-white mb-2">You Earn ₦500</h3>
              <p className="text-white/70 text-sm">
        ...
        >
          <h2 className="text-2xl font-black text-white mb-6">Your Referrals</h2>

          {referrals.length === 0 ? (
            <div className="text-center py-12">
              <Users className="w-16 h-16 text-white/20 mx-auto mb-4" />
              <h3 className="text-xl font-bold text-white mb-2">No referrals yet</h3>
              <p className="text-white/50">Start sharing your link to earn bonuses!</p>
            </div>
          ) : (
            <div className="space-y-4">
              {referrals.map((referral, index) => (
                <motion.div
                  ...
                  className="bg-black/30 border border-white/10 rounded-xl p-6 flex items-center justify-between"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="text-white font-bold">{referral.referred?.username || 'User'}</div>
                      <div className="text-white/50 text-sm">{referral.referred?.email}</div>
                  ...
                  <div className="text-right">
                    <div className={`px-4 py-2 rounded-full text-sm font-bold border mb-2 ${getStatusColor(referral.status)}`}>
