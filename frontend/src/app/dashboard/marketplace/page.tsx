            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/50 focus:border-purple-500 focus:outline-none"
                />
              </div>
              ...
              <select
                ...
                className="px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white focus:border-purple-500 focus:outline-none appearance-none"
              >
              ...
              <Link
                ...
                className="px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white font-bold rounded-xl transition-all flex items-center justify-center gap-2"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-slate-900 border border-white/10 rounded-2xl p-6 sticky top-4">
          ...
          <div className="lg:col-span-3">
            {loading ? (
              ...
              <div className="text-center py-20">
                ...
                <h3 className="text-2xl font-black text-white mb-2">No Accounts Found</h3>
...
function AccountCard({ account }: { account: any }) {
  ...
  return (
    <Link href={`/dashboard/marketplace/${account.id}`}>
      <motion.div
        whileHover={{ y: -5 }}
        className="bg-slate-900 border-2 border-white/10 hover:border-purple-500/50 rounded-2xl overflow-hidden transition-all group cursor-pointer"
      >
        {/* Image */}
        <div className="relative aspect-video bg-gradient-to-br from-purple-900/20 to-blue-900/20">
          ...
          <div className="absolute bottom-3 right-3 px-3 py-1 bg-black/60 backdrop-blur-sm rounded-full flex items-center gap-1">
            ...
            <span className="text-xs text-white font-bold">{account.views}</span>
          </div>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-white/10">
            ...
            <div className="px-4 py-2 bg-purple-500 group-hover:bg-purple-600 text-white font-bold rounded-xl transition-all">
              Buy Now
            </div>
          </div>
        </div>
